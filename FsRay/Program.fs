...
module Program =
    ...
    let rec shade (isect: Intersection) (scene: Scene) (depth: int) =
        ...
        let getNaturalColor (thing: Thing) (pos: Vector3) (normal: Vector3) (rd: Vector3) (scene: Scene) =
            let addLight (col: Vector3) (light: Light) =
                ...
                if isInShadow then
                    ...
                    let lcolor = if illum > 0f then light.color * illum else Color.black
            ...
            List.fold addLight Color.black scene.lights
        ...
        let naturalColor =
            Color.background + getNaturalColor isect.thing pos normal reflectDir scene
    ...
    and traceRay (ray: Ray) (scene: Scene) (depth: int) : Color =
        ...
        |> Option.defaultValue Color.background
